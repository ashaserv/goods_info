...
url = url.toString();
url = url.replace(/&/g, '|');
document.writeln('<' + 'script src=//shop.digiseller.ru/my/sell_good_info.asp?_ow=0&idd=' + idd + '&agent=184741&_ow=0' + agent + '&searchstr=' + searchstr + '&np=' + np + '&view=' + view + '&codepage=' + codepage + '&currency=' + currency + '&url=' + url + '>');
